...
d_t2 <- read.table("benchmark_targetrna2.csv", sep=";", header=T)
...
pdf("CopraRNA2_benchmark.pdf")
    ...
    # TargetRNA 2
    lines(targetrna_ranks_cumulated, col="darkkhaki", lwd=2)
    # IntaRNA
    ...
    legend(120, 40, c("CopraRNA 2 ooi", "CopraRNA 2 evo", "CopraRNA 1", "IntaRNA", "TargetRNA2"), col=c("cornflowerblue","cornflowerblue","coral","gray48","darkkhaki"), lty=c(1,2,1,1,1), lwd=2)
dev.off()
