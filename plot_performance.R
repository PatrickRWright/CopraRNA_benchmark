...
pdf("CopraRNA2_benchmark.pdf")
    ...
    # IntaRNA
    lines(intarna_ranks_cumulated, col="seagreen3", lwd=2)
    # CopraRNA 2 ooi
    lines(c2_ooi_rank_cumulated, col="cornflowerblue", lwd=2)
    # CopraRNA 2 evo
    lines(c2_evo_rank_cumulated, col=1, lwd=2)

    legend(120, 40, c("CopraRNA 1", "CopraRNA 2 ooi", "CopraRNA 2 evo", "IntaRNA"), col=c("coral","cornflowerblue",1,"seagreen3"), lty=c(1,1,1,1), lwd=2)
dev.off()
